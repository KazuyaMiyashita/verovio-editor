...
export class MidiPlayer {
    ...
    private readonly midiToolbar: MidiToolbar;
    ...
    public setExpansionMap(expansionMap: Record<string, string[]>): void { this.expansionMap = expansionMap || {}; }

    public getExpansionMap(): Record<string, string[]> { return this.expansionMap; }
