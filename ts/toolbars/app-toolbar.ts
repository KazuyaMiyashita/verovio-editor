...
export class AppToolbar extends Toolbar {
  ...
  private readonly fileImportCMME: HTMLDivElement;
  ...
  constructor(div: HTMLDivElement, app: App) {
    ...
    this.viewSelector = appendDivTo(viewSelectorMenu, {
      class: `vrv-btn-icon-left`,
      style: { backgroundImage: `url(${iconsLayout})` },
      "data-before": `View`,
    });
    const viewSelectorSubmenuContent = appendDivTo(viewSelectorMenu, {
    ...
    if (this.app.options.enableDocument) {
      this.viewDocument = appendDivTo(viewSelectorSubmenuContent, {
        class: `vrv-menu-icon-left`,
        style: { backgroundImage: `url(${iconsDocument})` },
    ...
    if (this.app.options.enableResponsive) {
      this.viewResponsive = appendDivTo(viewSelectorSubmenuContent, {
        class: `vrv-menu-icon-left`,
        style: { backgroundImage: `url(${iconsResponsive})` },
        "data-before": `Responsive`,
      });
      this.viewResponsive.dataset.view = "responsive";
      this.app.eventManager.bind(
        this.viewResponsive,
        "click",
        this.app.setView,
      );
    ...
    if (this.app.options.enableEditor) {
      this.viewEditor = appendDivTo(viewSelectorSubmenuContent, {
        class: `vrv-menu-icon-left`,
        style: { backgroundImage: `url(${iconsEditor})` },
        "data-before": `Editor`,
      });
    ...
    this.fileMenuBtn = appendDivTo(fileMenu, {
      class: `vrv-btn-text`,
      "data-before": `File`,
    });
    const fileMenuContent = appendDivTo(fileMenu, {
      class: `vrv-menu-content`,
    });
    appendDivTo(fileMenuContent, { class: `vrv-v-separator` });

    this.fileImport = appendDivTo(fileMenuContent, {
      class: `vrv-menu-text`,
    ...
    this.fileImportMusicXML = appendDivTo(fileMenuContent, {
      class: `vrv-menu-text`,
      "data-before": `Import MusicXML file`,
    });
    fileMenuContent.appendChild(this.fileImportMusicXML);
    this.app.eventManager.bind(
      this.fileImportMusicXML,
      "click",
      this.app.fileImport,
    );

    this.fileImportCMME = appendDivTo(fileMenuContent, {
      class: `vrv-menu-text`,
    ...
    const fileRecentSubMenu = appendDivTo(fileMenuContent, {
      class: `vrv-submenu`,
    });
    this.fileRecent = appendDivTo(fileRecentSubMenu, {
      class: `vrv-submenu-text`,
      "data-before": `Recent files`,
    });

    this.subSubMenu = appendDivTo(fileRecentSubMenu, {
      class: `vrv-submenu-content`,
    });
    appendDivTo(fileMenuContent, { class: `vrv-v-separator` });

    const fileExport = appendDivTo(fileMenuContent, {
      class: `vrv-menu-text`,
    ...
    const fileCopy = appendDivTo(fileMenuContent, {
      class: `vrv-menu-text`,
    ...
    const fileExportPDF = appendDivTo(fileMenuContent, {
      class: `vrv-menu-text`,
      "data-before": `Export as PDF`,
    });
    this.app.eventManager.bind(fileExportPDF, "click", this.app.fileExportPDF);

    const fileExportMIDI = appendDivTo(fileMenuContent, {
      class: `vrv-menu-text`,
    ...
    this.app.eventManager.bind(
      fileExportMIDI,
      "click",
      this.app.fileExportMIDI,
    );

    appendDivTo(fileMenuContent, { class: `vrv-v-separator` });

    this.fileSelection = appendDivTo(fileMenuContent, {
      class: `vrv-menu-text`,
    ...
    this.githubMenu = appendDivTo(this.div, {
      class: `vrv-menu`,
      style: { display: `none` },
    });
    appendDivTo(this.githubMenu, {
      class: `vrv-btn-text`,
      "data-before": `GitHub`,
    });
    const githubMenuContent = appendDivTo(this.githubMenu, {
      class: `vrv-menu-content`,
    });
    appendDivTo(githubMenuContent, { class: `vrv-v-separator` });

    this.githubImport = appendDivTo(githubMenuContent, {
      class: `vrv-menu-text`,
    ...
    this.app.eventManager.bind(
      this.githubImport,
      "click",
      this.app.githubImport,
    );

    this.githubExport = appendDivTo(githubMenuContent, {
      class: `vrv-menu-text`,
    ...
    this.prevPage = appendDivTo(this.pageControls, {
      class: `vrv-btn-icon-left`,
      style: { backgroundImage: `url(${iconsArrowLeft})` },
      "data-before": `Previous`,
    });
    this.app.eventManager.bind(this.prevPage, "click", this.app.prevPage);

    this.nextPage = appendDivTo(this.pageControls, {
      class: `vrv-btn-icon`,
      style: { backgroundImage: `url(${iconsArrowRight})` },
      "data-before": `Next`,
    });
    ...
    this.zoomOut = appendDivTo(this.zoomControls, {
      class: `vrv-btn-icon-left`,
      style: { backgroundImage: `url(${iconsZoomOut})` },
      "data-before": `Zoom out`,
    });
    this.app.eventManager.bind(this.zoomOut, "click", this.app.zoomOut);

    this.zoomIn = appendDivTo(this.zoomControls, {
      class: `vrv-btn-icon`,
      style: { backgroundImage: `url(${iconsZoomIn})` },
      "data-before": `Zoom in`,
    });
    ...
    appendDivTo(settingsMenu, {
      class: `vrv-btn-icon-left`,
      style: { backgroundImage: `url(${iconsSettings})` },
      "data-before": `Settings`,
    });
    const settingsMenuContent = appendDivTo(settingsMenu, {
      class: `vrv-menu-content`,
    });
    appendDivTo(settingsMenuContent, { class: `vrv-v-separator` });

    this.settingsEditor = appendDivTo(settingsMenuContent, {
      class: `vrv-menu-text`,
    ...
    this.app.eventManager.bind(
      this.settingsEditor,
      "click",
      this.app.settingsEditor,
    );

    this.settingsVerovio = appendDivTo(settingsMenuContent, {
      class: `vrv-menu-text`,
      "data-before": `Verovio options`,
    });
    this.app.eventManager.bind(
      this.settingsVerovio,
      "click",
      this.app.settingsVerovio,
    );
    ...
    this.logout = appendDivTo(this.loginGroup, {
      class: `vrv-btn-text`,
      style: { display: `none` },
      "data-before": `Logout`,
    });
    ...
    this.login = appendDivTo(this.loginGroup, {
      class: `vrv-btn-icon`,
      style: { backgroundImage: `url(${iconsGithubSignin})` },
      "data-before": `Github`,
    });
    ...
    Array.from(this.div.querySelectorAll("div.vrv-menu-text")).forEach(
      (node) => {
  ...
  public getMidiPlayerSubToolbar(): HTMLDivElement {
  ...
  public updateRecent(): void {
    ...
    let fileList: Array<{ idx: number; filename: string }> =
      this.app.fileStack.fileList();
    for (let i = 0; i < fileList.length; i++) {
      const entry = appendDivTo(this.subSubMenu, {
        class: `vrv-menu-text`,
        "data-before": fileList[i].filename,
      });
  ...
  onMouseOver(e: CustomEvent): void {
    Array.from(this.div.querySelectorAll("div.vrv-menu-content")).forEach(
      (node) => {
