...
export class EditorContentPanel extends GenericView {
  ...
  private readonly attributeListObj;
  EditorAttributeList;
  ...
  constructor(
    ...
    this.contentTreeObj = new EditorContentTree(
      this.contentTree,
      this.app,
      this.tab,
    );
    ...
    this.customEventManager.addToPropagationList(
      this.contentTreeObj.customEventManager,
    );
    ...
    this.attributeListObj = new EditorAttributeList(
      this.attributeList,
      this.app,
      this.tab,
      this.actionManager,
    ...
    this.customEventManager.addToPropagationList(
      this.attributeListObj.customEventManager,
    );
    ...
    this.referencesFromObj = new EditorReferenceList(
      this.referencesFrom,
      this.app,
      this.tab,
    );
    this.customEventManager.addToPropagationList(
      this.referencesFromObj.customEventManager,
    );
    ...
    this.referencesToObj = new EditorReferenceList(
      this.referencesTo,
      this.app,
      this.tab,
    );
  ...
  private async updateContent(id: string): Promise<any> {
    ...
    if (contextOk) {
      const jsonContent =
        (await this.app.verovio.editInfo()) as EditorContentTree.Content;
      this.contentTreeObj.loadContext(jsonContent);
      if (id !== "") {
        this.attributeListObj.loadAttributesOrText(jsonContent.object);
        this.referencesFromObj.loadList(
          jsonContent.referringElements,
          EditorReferenceList.Direction.From,
        );
        this.referencesToObj.loadList(
          jsonContent.referencedElements,
          EditorReferenceList.Direction.To,
        );
      }
    }
